...
sigmaalphas = [ones(1, P/2),  zeros(1, P/2); ...
               1:(P/2),       zeros(1, P/2); ...
               2 * (1:(P/2)), zeros(1, P/2)];   % Covariance matrix of random effects
sigma = 1;
for isigmaalpha = 1 : 3
    sigmaalpha = diag(sigmaalphas(isigmaalpha, :));
    for tau = [0.25 0.5 0.75]
        for ip = 1 : 11
            ...
            for irepeat = 1 : 100
                ...
                disp(['D', num2str(isigmaalpha), '_tau_', num2str(tau), ...
        ...
        writematrix([MSEm, MSEs, Corrm, Corrs, Incorrm, Incorrs, CorrNum], ...
            ['Simulation2_n25m20_D', num2str(isigmaalpha), '_tau', num2str(tau), '.csv'])
    end
end
